...
namespace Editor {
	...
	void HeightTemperatureDialogue::previewCalculateData(void) {
		...
		// Create noise
		Common::FbnNoise *heightNoise=new Common::FbnNoise(params.heightNoiseSeed, params.heightNoiseOctaves, params.heightNoiseFrequency);
		Common::FbnNoise *temperatureNoise=new Common::FbnNoise(params.temperatureNoiseSeed, params.temperatureNoiseOctaves, params.temperatureNoiseFrequency);
	...
	gboolean heightTemperatureDialoguePreviewHeightDrawingAreaDraw(GtkWidget *widget, cairo_t *cr, gpointer userData) {
		Editor::HeightTemperatureDialogue *dialogue=(Editor::HeightTemperatureDialogue *)userData;
