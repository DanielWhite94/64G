...
namespace Graphics {
	...
	public:
		...
		void refresh(const Graphics::Camera *camera, class Map *map, const MapObject *player);
	...
	private:
		...
		void renderHitMask(Common::Physics::HitMask hitmask, int sx, int sy, int r, int g, int b);
